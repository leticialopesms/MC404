...
setCanvasSize:
    li a0, 64       # a0: canvas width (value between 0 and 512)
    li a1, 64       # a1: canvas height (value between 0 and 512)
...
to_int:
    ...
    addi t2, t2, -2 # Agora t2 não aponta mais para "\n"
    LOOP_to_int:
...
main:
    ...
    li a2, 0x400000 # a2 = size (reads only 4194304 bytes)
                    # 4194304 is the maximum size of the image
    addi a2, a2, 15 # 15 is the maximum size of the file
    jal read_file
